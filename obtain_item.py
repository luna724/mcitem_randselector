...
def obtain_item(mcver):
  def get_ids_1165():
    return [
        ...
        "Acacia Wood with Bark(minecraft:acacia_wood)",
        "Activator Rails(minecraft:activator_rail)",
        "Air(minecraft:air)",
        ...
        "Birch Wood with Bark(minecraft:birch_wood)",
        ...
        "Chain Boots(minecraft:chainmail_boots)",
        "Chain Chestplate(minecraft:chainmail_chestplate)",
        "Chain Helmet(minecraft:chainmail_helmet)",
        "Chain Leggings(minecraft:chainmail_leggings)",
        ...
        "Slightly Damaged Anvil(minecraft:chipped_anvil)",
        ...
        "Raw Cod(minecraft:cod)",
        "Bucket of Cod(minecraft:cod_bucket)",
        "Cod Spawn Egg(minecraft:cod_spawn_egg)",
        "Command Block(minecraft:command_block)",
        "Minecart with Command Block(minecraft:command_block_minecart)",
        ...
        "Creeper Charge Banner Pattern(minecraft:creeper_banner_pattern)",
        ...
        "Very Damaged Anvil(minecraft:damaged_anvil)",
        ...
        "Dark Oak Wood with Bark(minecraft:dark_oak_wood)",
        ...
        "Detector Rails(minecraft:detector_rail)",
        ...
        "Fern(minecraft:fern)",
        "Map (Filled)(minecraft:filled_map)",
        ...
        "Flower Charge Banner Pattern(minecraft:flower_banner_pattern)",
        "Flower Pot(minecraft:flower_pot)",
        "Fox Spawn Egg(minecraft:fox_spawn_egg)",
        "Furnace(minecraft:furnace)",
        "Minecart with Furnace(minecraft:furnace_minecart)",
        ...
        "Gold Horse Armor(minecraft:golden_horse_armor)",
        ...
        "Dirt Path(minecraft:grass_path)",
        ...
        "Minecart with Hopper(minecraft:hopper_minecart)",
        ...
        "Jungle Wood with Bark(minecraft:jungle_wood)",
        "Kelp(minecraft:kelp)",
        ...
        "Leather Tunic(minecraft:leather_chestplate)",
        "Leather Cap(minecraft:leather_helmet)",
        "Leather Horse Armor(minecraft:leather_horse_armor)",
        "Leather Pants(minecraft:leather_leggings)",
        ...
        "Lingering Potion of Fire Resistance (0:45)(minecraft:lingering_potion)",
        "Lingering Potion of Fire Resistance (2:00)(minecraft:lingering_potion)",
        "Lingering Potion of Harming (Instant Damage II)(minecraft:lingering_potion)",
        "Lingering Potion of Harming (Instant Damage)(minecraft:lingering_potion)",
        "Lingering Potion of Healing (Instant Health II)(minecraft:lingering_potion)",
        "Lingering Potion of Healing (Instant Health)(minecraft:lingering_potion)",
        "Lingering Potion of Invisibility (0:45)(minecraft:lingering_potion)",
        "Lingering Potion of Invisibility (2:00)(minecraft:lingering_potion)",
        "Lingering Potion of Leaping (0:22 - Jump Boost II)(minecraft:lingering_potion)",
        "Lingering Potion of Leaping (0:45 - Jump Boost)(minecraft:lingering_potion)",
        "Lingering Potion of Leaping (2:00 - Jump Boost)(minecraft:lingering_potion)",
        "Lingering Potion of Luck (1:15)(minecraft:lingering_potion)",
        "Lingering Potion of Night Vision (0:45)(minecraft:lingering_potion)",
        "Lingering Potion of Night Vision (2:00)(minecraft:lingering_potion)",
        "Lingering Potion of Poison (0:05 - Poison II)(minecraft:lingering_potion)",
        "Lingering Potion of Poison (0:11)(minecraft:lingering_potion)",
        "Lingering Potion of Poison (0:22/0:30)(minecraft:lingering_potion)",
        "Lingering Potion of Regeneration (0:05 - Regeneration II)(minecraft:lingering_potion)",
        "Lingering Potion of Regeneration (0:11)(minecraft:lingering_potion)",
        "Lingering Potion of Regeneration (0:22/0:30)(minecraft:lingering_potion)",
        "Lingering Potion of Slow Falling (0:22)(minecraft:lingering_potion)",
        "Lingering Potion of Slow Falling (1:00)(minecraft:lingering_potion)",
        "Lingering Potion of Slowness (0:05 - Slowness IV)(minecraft:lingering_potion)",
        "Lingering Potion of Slowness (0:22)(minecraft:lingering_potion)",
        "Lingering Potion of Slowness (1:00)(minecraft:lingering_potion)",
        "Lingering Potion of Strength (0:22 - Strength II)(minecraft:lingering_potion)",
        "Lingering Potion of Strength (0:45)(minecraft:lingering_potion)",
        "Lingering Potion of Strength (2:00)(minecraft:lingering_potion)",
        "Lingering Potion of Swiftness (0:22 - Speed II)(minecraft:lingering_potion)",
        "Lingering Potion of Swiftness (0:45 - Speed)(minecraft:lingering_potion)",
        "Lingering Potion of Swiftness (2:00 - Speed)(minecraft:lingering_potion)",
        "Lingering Potion of Water Breathing (0:45)(minecraft:lingering_potion)",
        "Lingering Potion of Water Breathing (2:00)(minecraft:lingering_potion)",
        "Lingering Potion of Weakness (0:22)(minecraft:lingering_potion)",
        "Lingering Potion of Weakness (1:00)(minecraft:lingering_potion)",
        "Lingering Potion of the Turtle Master (0:05 - Slowness IV, Resistance III)(minecraft:lingering_potion)",
        "Lingering Potion of the Turtle Master (0:05 - Slowness VI, Resistance IV)(minecraft:lingering_potion)",
        "Lingering Potion of the Turtle Master (0:10 - Slowness IV, Resistance III)(minecraft:lingering_potion)",
        ...
        "Music Disc (C418 - 11)(minecraft:music_disc_11)",
        "Music Disc (C418 - 13)(minecraft:music_disc_13)",
        "Music Disc (C418 - blocks)(minecraft:music_disc_blocks)",
        "Music Disc (C418 - cat)(minecraft:music_disc_cat)",
        "Music Disc (C418 - chirp)(minecraft:music_disc_chirp)",
        "Music Disc (C418 - far)(minecraft:music_disc_far)",
        "Music Disc (C418 - mall)(minecraft:music_disc_mall)",
        "Music Disc (C418 - mellohi)(minecraft:music_disc_mellohi)",
        "Music Disc (Lena Raine - Pigstep)(minecraft:music_disc_pigstep)",
        "Music Disc (C418 - stal)(minecraft:music_disc_stal)",
        "Music Disc (C418 - strad)(minecraft:music_disc_strad)",
        "Music Disc (C418 - wait)(minecraft:music_disc_wait)",
        "Music Disc (C418 - ward)(minecraft:music_disc_ward)",
        ...
        "Block of Nether Bricks(minecraft:nether_bricks)",
        ...
        "Oak Wood with Bark(minecraft:oak_wood)",
        ...
        "Snout Banner Pattern(minecraft:piglin_banner_pattern)",
        ...
        "Potion of Fire Resistance (3:00)(minecraft:potion)",
        "Potion of Fire Resistance (8:00)(minecraft:potion)",
        "Potion of Harming (Instant Damage II)(minecraft:potion)",
        "Potion of Harming (Instant Damage)(minecraft:potion)",
        "Potion of Healing (Instant Health II)(minecraft:potion)",
        "Potion of Healing (Instant Health)(minecraft:potion)",
        "Potion of Invisibility (3:00)(minecraft:potion)",
        "Potion of Invisibility (8:00)(minecraft:potion)",
        "Potion of Leaping (1:30 - Jump Boost II)(minecraft:potion)",
        "Potion of Leaping (3:00 - Jump Boost)(minecraft:potion)",
        "Potion of Leaping (8:00 - Jump Boost)(minecraft:potion)",
        "Potion of Luck (5:00)(minecraft:potion)",
        "Potion of Night Vision (3:00)(minecraft:potion)",
        "Potion of Night Vision (8:00)(minecraft:potion)",
        "Potion of Poison (0:21/0:22 - Poison II)(minecraft:potion)",
        "Potion of Poison (0:45)(minecraft:potion)",
        "Potion of Poison (1:30/2:00)(minecraft:potion)",
        "Potion of Regeneration (0:22 - Regeneration II)(minecraft:potion)",
        "Potion of Regeneration (0:45)(minecraft:potion)",
        "Potion of Regeneration (1:30/2:00)(minecraft:potion)",
        "Potion of Slow Falling (1:30)(minecraft:potion)",
        "Potion of Slow Falling (4:00)(minecraft:potion)",
        "Potion of Slowness (0:20 - Slowness IV)(minecraft:potion)",
        "Potion of Slowness (1:30)(minecraft:potion)",
        "Potion of Slowness (4:00)(minecraft:potion)",
        "Potion of Strength (1:30 - Strength II)(minecraft:potion)",
        "Potion of Strength (3:00)(minecraft:potion)",
        "Potion of Strength (8:00)(minecraft:potion)",
        "Potion of Swiftness (1:30 - Speed II)(minecraft:potion)",
        "Potion of Swiftness (3:00 - Speed)(minecraft:potion)",
        "Potion of Swiftness (8:00 - Speed)(minecraft:potion)",
        "Potion of Water Breathing (3:00)(minecraft:potion)",
        "Potion of Water Breathing (8:00)(minecraft:potion)",
        "Potion of Weakness (1:30)(minecraft:potion)",
        "Potion of Weakness (4:00)(minecraft:potion)",
        "Potion of the Turtle Master (0:20 - Slowness IV, Resistance III)(minecraft:potion)",
        "Potion of the Turtle Master (0:20 - Slowness VI, Resistance IV)(minecraft:potion)",
        "Potion of the Turtle Master (0:40 - Slowness IV, Resistance III)(minecraft:potion)",
        "Water Bottle(minecraft:potion)",
        "Powered Rails(minecraft:powered_rail)",
        "Prismarine(minecraft:prismarine)",
        "Prismarine Brick Slab(minecraft:prismarine_brick_slab)",
        "Prismarine Bricks Stairs(minecraft:prismarine_brick_stairs)",
        ...
        "Bucket of Pufferfish(minecraft:pufferfish_bucket)",
        ...
        "Red Nether Brick(minecraft:red_nether_bricks)",
        ...
        "Raw Salmon(minecraft:salmon)",
        "Bucket of Salmon(minecraft:salmon_bucket)",
        ...
        "Skull Charge Banner Pattern(minecraft:skull_banner_pattern)",
        ...
        "Splash Potion of Fire Resistance (3:00/2:15)(minecraft:splash_potion)",
        "Splash Potion of Fire Resistance (8:00/6:00)(minecraft:splash_potion)",
        "Splash Potion of Harming (Instant Damage II)(minecraft:splash_potion)",
        "Splash Potion of Harming (Instant Damage)(minecraft:splash_potion)",
        "Splash Potion of Healing (Instant Health II)(minecraft:splash_potion)",
        "Splash Potion of Healing (Instant Health)(minecraft:splash_potion)",
        "Splash Potion of Invisibility (3:00/2:15)(minecraft:splash_potion)",
        "Splash Potion of Invisibility (8:00/6:00)(minecraft:splash_potion)",
        "Splash Potion of Leaping (1:30/1:07 - Jump Boost II)(minecraft:splash_potion)",
        "Splash Potion of Leaping (3:00/2:15 - Jump Boost)(minecraft:splash_potion)",
        "Splash Potion of Leaping (8:00/6:00 - Jump Boost)(minecraft:splash_potion)",
        "Splash Potion of Luck (5:00)(minecraft:splash_potion)",
        "Splash Potion of Night Vision (3:00/2:15)(minecraft:splash_potion)",
        "Splash Potion of Night Vision (8:00/6:00)(minecraft:splash_potion)",
        "Splash Potion of Poison (0:21/0:16 - Poison II)(minecraft:splash_potion)",
        "Splash Potion of Poison (0:45/0:33)(minecraft:splash_potion)",
        "Splash Potion of Poison (1:30)(minecraft:splash_potion)",
        "Splash Potion of Regeneration (0:22/0:16 - Regeneration II)(minecraft:splash_potion)",
        "Splash Potion of Regeneration (0:45/0:33)(minecraft:splash_potion)",
        "Splash Potion of Regeneration (1:30)(minecraft:splash_potion)",
        "Splash Potion of Slow Falling (1:30/1:07)(minecraft:splash_potion)",
        "Splash Potion of Slow Falling (4:00/3:00)(minecraft:splash_potion)",
        "Splash Potion of Slowness (0:20/0:15 - Slowness IV)(minecraft:splash_potion)",
        "Splash Potion of Slowness (1:30/1:07)(minecraft:splash_potion)",
        "Splash Potion of Slowness (4:00/3:00)(minecraft:splash_potion)",
        "Splash Potion of Strength (1:30/1:07 - Strength II)(minecraft:splash_potion)",
        "Splash Potion of Strength (3:00/2:15)(minecraft:splash_potion)",
        "Splash Potion of Strength (8:00/6:00)(minecraft:splash_potion)",
        "Splash Potion of Swiftness (1:30/1:07 - Speed II)(minecraft:splash_potion)",
        "Splash Potion of Swiftness (3:00/2:15 - Speed)(minecraft:splash_potion)",
        "Splash Potion of Swiftness (8:00/6:00 - Speed)(minecraft:splash_potion)",
        "Splash Potion of Water Breathing (3:00/2:15)(minecraft:splash_potion)",
        "Splash Potion of Water Breathing (8:00/6:00)(minecraft:splash_potion)",
        "Splash Potion of Weakness (1:30/1:07)(minecraft:splash_potion)",
        "Splash Potion of Weakness (4:00/3:00)(minecraft:splash_potion)",
        "Splash Potion of the Turtle Master (0:15 - Slowness IV, Resistance III)(minecraft:splash_potion)",
        "Splash Potion of the Turtle Master (0:20/0:15 - Slowness VI, Resistance IV)(minecraft:splash_potion)",
        "Splash Potion of the Turtle Master (0:30 - Slowness IV, Resistance III)(minecraft:splash_potion)",
        ...
        "Spruce Wood with Bark(minecraft:spruce_wood)",
        ...
        "Sugar Canes(minecraft:sugar_cane)",
        ...
        "Arrow of Fire Resistance (0:22)(minecraft:tipped_arrow)",
        "Arrow of Fire Resistance (1:00)(minecraft:tipped_arrow)",
        "Arrow of Harming (Instant Damage II)(minecraft:tipped_arrow)",
        "Arrow of Harming (Instant Damage)(minecraft:tipped_arrow)",
        "Arrow of Healing (Instant Health II)(minecraft:tipped_arrow)",
        "Arrow of Healing (Instant Health)(minecraft:tipped_arrow)",
        "Arrow of Invisibility (0:22)(minecraft:tipped_arrow)",
        "Arrow of Invisibility (1:00)(minecraft:tipped_arrow)",
        "Arrow of Leaping (0:11 - Jump Boost II)(minecraft:tipped_arrow)",
        "Arrow of Leaping (0:22 - Jump Boost)(minecraft:tipped_arrow)",
        "Arrow of Leaping (1:00 - Jump Boost)(minecraft:tipped_arrow)",
        "Arrow of Luck (0:37)(minecraft:tipped_arrow)",
        "Arrow of Night Vision (0:22)(minecraft:tipped_arrow)",
        "Arrow of Night Vision (1:00)(minecraft:tipped_arrow)",
        "Arrow of Poison (0:02 - Poison II)(minecraft:tipped_arrow)",
        "Arrow of Poison (0:05)(minecraft:tipped_arrow)",
        "Arrow of Poison (0:11/0:15)(minecraft:tipped_arrow)",
        "Arrow of Regeneration (0:02 - Regeneration II)(minecraft:tipped_arrow)",
        "Arrow of Regeneration (0:05)(minecraft:tipped_arrow)",
        "Arrow of Regeneration (0:11/0:15)(minecraft:tipped_arrow)",
        "Arrow of Slow Falling (0:11)(minecraft:tipped_arrow)",
        "Arrow of Slow Falling (0:30)(minecraft:tipped_arrow)",
        "Arrow of Slowness (0:02 - Slowness IV)(minecraft:tipped_arrow)",
        "Arrow of Slowness (0:11)(minecraft:tipped_arrow)",
        "Arrow of Slowness (0:30)(minecraft:tipped_arrow)",
        "Arrow of Strength (0:11 - Strength II)(minecraft:tipped_arrow)",
        "Arrow of Strength (0:22)(minecraft:tipped_arrow)",
        "Arrow of Strength (1:00)(minecraft:tipped_arrow)",
        "Arrow of Swiftness (0:11 - Speed II)(minecraft:tipped_arrow)",
        "Arrow of Swiftness (0:22 - Speed)(minecraft:tipped_arrow)",
        "Arrow of Swiftness (1:00 - Speed)(minecraft:tipped_arrow)",
        "Arrow of Water Breathing (0:22)(minecraft:tipped_arrow)",
        "Arrow of Water Breathing (1:00)(minecraft:tipped_arrow)",
        "Arrow of Weakness (0:11)(minecraft:tipped_arrow)",
        "Arrow of Weakness (0:30)(minecraft:tipped_arrow)",
        "Arrow of the Turtle Master (0:02 - Slowness IV, Resistance III)(minecraft:tipped_arrow)",
        "Arrow of the Turtle Master (0:02 - Slowness VI, Resistance IV)(minecraft:tipped_arrow)",
        "Arrow of the Turtle Master (0:05 - Slowness IV, Resistance III)(minecraft:tipped_arrow)",
        "TNT(minecraft:tnt)",
        ...
        "Tropical Fish (Clownfish)(minecraft:tropical_fish)",
        "Bucket of Tropical Fish(minecraft:tropical_fish_bucket)",
        ...
        "Book and Quill(minecraft:writable_book)",
  ...
  #     return get.text
  #   else:
  #     raise RuntimeError("request wasn't completed correctly. ({})".format(get.status_code))
  
  # robots.txt >
  # MC 1.16.5 > https://www.digminecraft.com/robots.txt
  # MC 1.12.2 > https://minecraft-ids.grahamedgecombe.com/robots.txt

  if mcver == "1.12.2":
    # # MC 1.12.2
    # url = "https://minecraft-ids.grahamedgecombe.com/"    
    # soup = BeautifulSoup(send_req(url), 'html.parser')
    # # rows id下の tr/td(.row-desc)/span(.name) の値をすべて摘出
    # names = []

    # for elem in soup.find(id="rows").find_all("tr"):
    #   elem:BeautifulSoup #IDE

    #   try:
    #     td = elem.select(".row-desc")
    #     if td:
    #       span = td[0].select(".name")
        
    #       if span:
    #         names.append(span[0].text)
    ...
    # for elem in soup.find(id="minecraft_items").find_all("tr"):
    #   try:
    #     td = elem.find_all("td")[1]
        
    #     name = td.text.split("<br>")[0]
    #     if name.count("<a href=") >= 1:
    #       pattern = r'">(.*)</a>'
